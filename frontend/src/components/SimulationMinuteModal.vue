<template>
  <Teleport to="body">
    <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div class="relative bg-white rounded-2xl shadow-2xl w-[700px] max-h-[80vh] overflow-hidden">
        <!-- 头部 -->
        ...
        <div class="p-4" style="height: 400px;">
          ...
          <div v-else-if="error" class="flex items-center justify-center h-full text-amber-500">
            {{ error }}
          </div>
...
const chartOption = computed(() => {
  ...
  return {
    ...
    xAxis: [
      ...
      { type: 'category', data: times, gridIndex: 1, axisLabel: { fontSize: 10, interval: Math.floor(times.length / 6) }, boundaryGap: false }
    ],
    yAxis: [
    ...
    series: [
      {
        ...
        areaStyle: {
          color: {
            ...
            colorStops: [
              { offset: 0, color: isUp ? 'rgba(255,77,79,0.2)' : 'rgba(82,196,26,0.2)' },
